...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Activity.objects.create(user='superman', type='Running', duration=60, team='DC')

        # Create leaderboard
        Leaderboard.objects.create(user='ironman', team='Marvel', points=100)
        Leaderboard.objects.create(user='batman', team='DC', points=120)
        Leaderboard.objects.create(user='spiderman', team='Marvel', points=90)
